...
<head>
	...
	<link rel="stylesheet" type="text/css"
		  href="../../../application/assets/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css"
		  href="../../../application/assets/fonts/iconic/css/material-design-iconic-font.min.css">
	<!--===============================================================================================-->
...
<div class="limiter">
	<div class="container-login100" style="background-image: url('../../../application/assets/Imgs/bg-01.jpg')">
		<div class="wrap-login100">
			<form style="justify-content: center" class="login100-form validate-form" action="" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate="Enter username">
					<?php
					echo form_input('login', set_value('login'), array('class' => 'input100', 'placeholder' => 'Login', 'name' => 'login'));
					?>
				...
				<div class="wrap-input100 validate-input" data-validate="Enter email">
					<?php
					echo form_input('email', set_value('email'), array('class' => 'input100', 'placeholder' => 'Email', 'name' => 'email'));
					?>
					<span class="focus-input100" data-placeholder="&#xf191;"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Enter senha">
					<?php
					echo form_password('senha', set_value('senha'), array('class' => 'input100', 'placeholder' => 'Senha', 'name' => 'senha'));
					?>
					<span class="focus-input100" data-placeholder="&#xf191;"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Enter senha2">
					<?php
					echo form_password('senha2', set_value('senha2'), array('class' => 'input100', 'placeholder' => 'Repita a senha', 'name' => 'senha2'));
					?>
					<span class="focus-input100" data-placeholder="&#xf191;"></span>
				</div>
				...
				<div class="container-login100-form-btn">
					<?php
					echo form_submit('enviar', 'Salvar dados', array('class' => 'login100-form-btn'));
					?>
				</div>
			</form>
		</div>
